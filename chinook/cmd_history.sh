...
script/ra_chinookdemo_create.pl    model DB    DBIC::Schema    RA::ChinookDemo::DB    create=static generate_pod=0    dbi:SQLite:chinook.db    sqlite_unicode=1    on_connect_call='use_foreign_keys'    quote_names=1  #<-- required for RapidApp 
 #
